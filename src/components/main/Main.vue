<template>
  <div class="d-flex flex-column h-100">
    ...
    <div class="flex-grow-1 d-flex flex-row overflow-y-hidden no-gutters h-100">
      ...
      <div
        class="right d-none d-lg-block col-lg-2 col-xxl-1 carbon h-100 p-2 p-xxl-1 border-left border-right border-map-light"
      >
        <ControlGroup></ControlGroup>
      </div>
      <div class="right col-12 col-lg-7 col-xxl-8"><Map></Map></div>
    </div>
    <div
      id="footer"
      v-if="false"
