...
<div class="videoFrame childPoint" v-if="isVideoFrameOpen">
    <div class="controlFrame pt-3 px-3 pb-2 bg-black rounded">
      ...
      >
        ...
        <vimeo-player class="innerFrame rounded" ref="player" :options="vimeoOptions" :videoId="videoID" @ready="onReady" />
        <div class="topClose">
            <button class="btn btn-lg btn-black" v-on:click="closeVideoFrame()" :aria-label="$t(`Close`)">
